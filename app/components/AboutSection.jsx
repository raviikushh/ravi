  ...
  return (
   <section id='about' className='text-white'> <div className='md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 sm:py-16'>
        ...
        <div className='mt-4 md:mt-0 text-left flex flex-col h-full '>
            ...
            <p className='text-base lg:text-lg '>I am a final-year B.Tech student in Computer Science with a strong passion for software development. Currently, I am immersed in ReactJS and Next.js, working towards becoming a proficient MERN stack developer. I have completed projects using HTML, CSS, and JavaScript and actively contribute to open source projects, including Hacktoberfest 2023.</p>
