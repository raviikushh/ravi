  ...
  return (
    <section>
        <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <p className='text-[#ADB7BE] sm:text-lg lg:text-xl mb-6 text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi, repudiandae eveniet cumque ipsa voluptate vero harum, eligendi odit aliquam quisquam magni, commodi esse nulla laboriosam nostrum ullam corrupti? Rem, facilis.</p>
                <div className="">
